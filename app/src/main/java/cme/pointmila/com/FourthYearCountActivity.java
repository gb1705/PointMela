 ...
 */
public class FourthYearCountActivity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fourthyear_point);
        lstBooking = new ArrayList<HashMap<String,String>>();
        listView = (ListView)findViewById(R.id.listview);


        GetFourthYearPointList();
        // GetListOfPointsForAllYear();
    }

    protected void GetFourthYearPointList()
    {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    HttpPost httpPost = new HttpPost(General.baseurl+"CMEPoints/GetCMEPointsListForFourthYear");
                    ...
                    try
                    {
                        ...
                        if (strSuccess.equals("true"))
                        {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run()
                                {
                                    ListOfPointsAdapter pointslist = new ListOfPointsAdapter(FourthYearCountActivity.this,lstBooking);
                                    ...
                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            if (DetectConnection.isInternetAvailable(FourthYearCountActivity.this))
                                            {
                                                HashMap<String,String>data = lstBooking.get(position);
                                                Intent i = new Intent();
                                                i.setClass(FourthYearCountActivity.this,FourthYearPointEditingActivity.class);
                                                i.putExtra("PointId",data.get("PointID"));
                                                FourthYearCountActivity.this.startActivity(i);
                                                FourthYearCountActivity.this.finish();
                                            }
