 ...
 */
public class FifthYearPointAdapter extends BaseAdapter
{
    ...
    public FifthYearPointAdapter()
    {
        // this.appContext = appContext;
    }

    public FifthYearPointAdapter(Activity act, List<HashMap<String,String>> map)
    {
