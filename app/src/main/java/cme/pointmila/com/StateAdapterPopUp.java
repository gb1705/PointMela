 ...
 */
public class StateAdapterPopUp extends BaseAdapter
{
    LayoutInflater inflater;
    List<HashMap<String,String>> DataCollection;
    public Context appContext;
    public Fragment tmpActivity;
    public StateAdapterPopUp()
    {}
    public StateAdapterPopUp(Activity act,List<HashMap<String,String>> map)
    {
        try {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        try {
            ...
            holder.Text.setText(DataCollection.get(position).get("Statename"));
            holder.Truckid=DataCollection.get(position).get("StateId");
