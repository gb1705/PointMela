 ...
 */
public class MedicalCouncilAdapter extends BaseAdapter {
    ...
    public MedicalCouncilAdapter(Activity act, List<HashMap<String,String>> map)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            try {
                vi = inflater.inflate(R.layout.medicalcouncil_row, null);
        ...
        try {
            ...
            holder.Text.setText(DataCollection.get(position).get("MedicalCouncilname"));
            holder.councilId=Integer.parseInt(DataCollection.get(position).get("MedicalCouncilID"));
