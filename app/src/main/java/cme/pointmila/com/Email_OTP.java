...
public class Email_OTP extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle saveInstanceState)
    {
        ...
        setContentView(R.layout.changepassw_otp);
        ...
        Verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog = ProgressDialog.show(Email_OTP.this, "", "Please Wait....");
                ...
                timerthread.start();*/
                if (DetectConnection.isInternetAvailable(Email_OTP.this)) {
                    VerifyOTP();
                } else {
                    InternetMessage();
                }
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    HttpPost httpPost = new HttpPost(General.baseurl+"Email/VerifyEmailOTP");
                        ...
                        if (strResult.equals("true"))
                        {
                            runOnUiThread(new Runnable() {
                                ...
                                public void run()
                                {
                                    try {
                                        progressDialog.dismiss();
                                        Intent i = new Intent(getApplicationContext(), Email_OTPSuccessful.class);
                                        Email_OTP.this.startActivity(i);
                                        Email_OTP.this.finish();
                                    }
                                    catch (Exception e)
                                    {
                                        e.printStackTrace();
