 ...
 */
public class FirstYearCountActivity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.firstyear_point);
        lstBooking = new ArrayList<HashMap<String,String>>();
        listView = (ListView)findViewById(R.id.listview);


        GetFirstyearpointList();
        // GetListOfPointsForAllYear();
    }

    protected void GetFirstyearpointList()
    {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    HttpPost httpPost = new HttpPost(General.baseurl+"CMEPoints/GetCMEPointsListForFirstYear");
                    ...
                    try
                    {
                        ...
                        if (strSuccess.equals("true"))
                        {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run()
                                {
                                    ListOfPointsAdapter pointslist = new ListOfPointsAdapter(FirstYearCountActivity.this,lstBooking);
                                    listView.setAdapter(pointslist);

                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        @Override
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            if (DetectConnection.isInternetAvailable(FirstYearCountActivity.this))
                                            {
                                                HashMap<String,String>data = lstBooking.get(position);
                                                Intent i = new Intent();
                                                i.setClass(FirstYearCountActivity.this,FirstYearPointEditingActivity.class);
                                                i.putExtra("PointId",data.get("PointID"));
                                                FirstYearCountActivity.this.startActivity(i);
                                                FirstYearCountActivity.this.finish();
                                            }
