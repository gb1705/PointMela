 ...
 */
public class FirstYearPointAdapter extends BaseAdapter
{
    ...
    public FirstYearPointAdapter()
    {
        // this.appContext = appContext;
    }

    public FirstYearPointAdapter(Activity act, List<HashMap<String,String>> map)
    {
