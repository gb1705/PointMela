 ...
 */
public class SecondYearCountActivity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.secondyear_point);
        lstBooking = new ArrayList<HashMap<String,String>>();
        listView = (ListView)findViewById(R.id.listview);


        GetSecondYearPointList();
        // GetListOfPointsForAllYear();
    }

    protected void GetSecondYearPointList()
    {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    HttpPost httpPost = new HttpPost(General.baseurl+"CMEPoints/GetCMEPointsListForSecondYear");
                    ...
                    try
                    {
                        ...
                        if (strSuccess.equals("true"))
                        {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run()
                                {
                                    ListOfPointsAdapter pointslist = new ListOfPointsAdapter(SecondYearCountActivity.this,lstBooking);
                                    listView.setAdapter(pointslist);

                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        @Override
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            if (DetectConnection.isInternetAvailable(SecondYearCountActivity.this))
                                            {
                                                HashMap<String,String>data = lstBooking.get(position);
                                                Intent i = new Intent();
                                                i.setClass(SecondYearCountActivity.this,SecondYearPointEditingActivity.class);
                                                i.putExtra("PointId",data.get("PointID"));
                                                SecondYearCountActivity.this.startActivity(i);
                                                SecondYearCountActivity.this.finish();
                                            }
