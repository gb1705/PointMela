 ...
 */
public class SecondYearPointAdapter extends BaseAdapter
{
    ...
    public SecondYearPointAdapter()
    {
        // this.appContext = appContext;
    }

    public SecondYearPointAdapter(Activity act, List<HashMap<String,String>> map)
    {
