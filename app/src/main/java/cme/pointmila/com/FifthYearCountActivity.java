 ...
 */
public class FifthYearCountActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fifthyear_point);
        lstBooking = new ArrayList<HashMap<String, String>>();
        listView = (ListView) findViewById(R.id.listview);


        GetFifthYearPointList();
        // GetListOfPointsForAllYear();
    }

    protected void GetFifthYearPointList() {
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    HttpClient httpClient = new DefaultHttpClient();
                    HttpPost httpPost = new HttpPost(General.baseurl + "CMEPoints/GetCMEPointsListForFifthYear");
                    ...
                    try {
                        ...
                        if (strSuccess.equals("true")) {
                            ...
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    ListOfPointsAdapter pointslist = new ListOfPointsAdapter(FifthYearCountActivity.this, lstBooking);
                                    ...
                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            if (DetectConnection.isInternetAvailable(FifthYearCountActivity.this)) {
                                                HashMap<String, String> data = lstBooking.get(position);
                                                Intent i = new Intent();
                                                i.setClass(FifthYearCountActivity.this, FifthYearPointEditingActivity.class);
                                                i.putExtra("PointId", data.get("PointID"));
                                                FifthYearCountActivity.this.startActivity(i);
                                                FifthYearCountActivity.this.finish();
                                            } else {
                                                InternetMessage();
                                            }
                                        }
