 ...
 */
public class ThirdYearCountActvity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thirdyear_point);
        lstBooking = new ArrayList<HashMap<String,String>>();
        listView = (ListView)findViewById(R.id.listview);


        GetThirdYearPointList();
        // GetListOfPointsForAllYear();
    }

    protected void GetThirdYearPointList()
    {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run()
            {
                try
                {
                    ...
                    HttpPost httpPost = new HttpPost(General.baseurl+"CMEPoints/GetCMEPointsListForThirdYear");
                    ...
                    try
                    {
                        ...
                        if (strSuccess.equals("true"))
                        {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run()
                                {
                                    ListOfPointsAdapter pointslist = new ListOfPointsAdapter(ThirdYearCountActvity.this,lstBooking);
                                    listView.setAdapter(pointslist);

                                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        @Override
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            if (DetectConnection.isInternetAvailable(ThirdYearCountActvity.this))
                                            {
                                                HashMap<String,String>data = lstBooking.get(position);
                                                Intent i = new Intent();
                                                i.setClass(ThirdYearCountActvity.this,ThirdYearPointEditingActivity.class);
                                                i.putExtra("PointId",data.get("PointID"));
                                                ThirdYearCountActvity.this.startActivity(i);
                                                ThirdYearCountActvity.this.finish();
                                            }
