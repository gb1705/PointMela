 ...
 */
public class FourthYearPointAdpater extends BaseAdapter
{
    ...
    public FourthYearPointAdpater()
    {
        // this.appContext = appContext;
    }

    public FourthYearPointAdpater(Activity act, List<HashMap<String,String>> map)
    {
